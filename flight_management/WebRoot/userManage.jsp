<%@ page import="cn.jxufe.db.domain.user, cn.jxufe.db.service.AdminService, cn.jxufe.db.service.impl.AdminServiceImpl"%>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
			...
			<c:forEach var="u" items="${userList}">
				 <tr>
                  <td><c:out value="${u.userno}"/></td>
                  <td><c:out value="${u.username}"/></td>
                  <td><c:out value="${u.registercardno}"/></td>
                  <td>
                  <c:if test="${u.type==1}">管理员</c:if>
                  <c:if test="${u.type==0}">旅客</c:if>
                  </td>
                  <td>
                  	<button type="button" class="btn btn-xs btn-warning" onclick="javascript:window.location.href='updateUserInfo.jsp?userNo=${u.userno}';">修改</button>
                  </td>
                </tr>
			</c:forEach>
