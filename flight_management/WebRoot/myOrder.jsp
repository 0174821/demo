...
<%@page import="cn.jxufe.db.domain.ordermaster"%>
...
<%
	...
	/* PassengerDao pDao=new PassengerDaoimpl();//增加类
	List<ordermaster> orderList=pDao.getOrderListOfUser(user);
          ...
          <div class="table-responsive">
			...
			<%-- <c:forEach var="o" items="${orderList}">
				 <tr>
                  ...
                  <td><c:out value="${o.user.getUserno()}"/></td>
                  <td><c:out value="${o.flightclass.getFlightclassno()}"/></td>
                  <td>
                  	<c:if test="${o.isPayed}">
                  		<c:out value="是"/>
                  	</c:if>
