...
<%
	...
	/* AdminService aService=new AdminServiceImpl();//先建好类
	List<orderdetail> orderList = aService.listAllOrder();
          ...
          <div class="table-responsive">
			...
			<%-- <c:forEach var="o" items="${orderList}">
				 <tr>
                  ...
                  <td><c:out value="${o.ticketsum}"/></td>
                  <td><c:out value="${o.orderstatus}"/></td>
                  <td><c:out value="${o.userno}"/></td>
                  <td><c:out value="${o.flightno}"/></td>
                  <td><c:out value="${o.flightclassno}"/></td>
                  <td>
                  	<c:if test="${o.isPayed}">
                  		<c:out value="是"/>
                  	</c:if>
